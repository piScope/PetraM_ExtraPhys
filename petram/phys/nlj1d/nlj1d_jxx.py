...
dprint1, dprint2, dprint3 = debug.init_dprints('NLJ1D_Jxx')
...
class NLJ1D_Jxx(NLJ1D_BaseDomain):
    has_essential = False
    nlterms = []
    has_3rd_panel = True
    vt = Vtable(data)
    ...
    def __init__(self, **kwargs):
        super(NLJ1D_Jxx, self).__init__(**kwargs)
    ...
    def get_panel1_value(self):
        values = super(NLJ1D_Jxx, self).get_panel1_value()
